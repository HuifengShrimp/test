...
//lj
ArrayRef logreg_ap(Object* ctx, const ArrayRef&, const ArrayRef&, const ArrayRef&, size_t, size_t, size_t);
ArrayRef logreg_aa(Object* ctx, const ArrayRef&, const ArrayRef&, const ArrayRef&, size_t, size_t, size_t);
