...
class Beaver {
 public:
  ...
  //lj
  using Lr_set = std::tuple<ArrayRef, ArrayRef, ArrayRef, ArrayRef, ArrayRef, ArrayRef, ArrayRef>;
  using cr_set = std::tuple<ArrayRef, ArrayRef, ArrayRef, ArrayRef, ArrayRef>;
  ...
  virtual Triple LR_TEST(FieldType field, size_t M, size_t N, size_t K) = 0;
